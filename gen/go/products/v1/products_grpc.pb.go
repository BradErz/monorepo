...
type ProductsServiceClient interface {
	...
	GetProductOverview(ctx context.Context, in *GetProductOverviewRequest, opts ...grpc.CallOption) (*GetProductOverviewResponse, error)
}
...
func (c *productsServiceClient) ListProducts(ctx context.Context, in *ListProductsRequest, opts ...grpc.CallOption) (*ListProductsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/products.v1.ProductsService/ListProducts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productsServiceClient) CreateProduct(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateProductResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/products.v1.ProductsService/CreateProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productsServiceClient) GetProduct(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*GetProductResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/products.v1.ProductsService/GetProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productsServiceClient) GetProductOverview(ctx context.Context, in *GetProductOverviewRequest, opts ...grpc.CallOption) (*GetProductOverviewResponse, error) {
	out := new(GetProductOverviewResponse)
	err := c.cc.Invoke(ctx, "/products.v1.ProductsService/GetProductOverview", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductsServiceServer interface {
	...
	GetProductOverview(context.Context, *GetProductOverviewRequest) (*GetProductOverviewResponse, error)
}
...
func (UnimplementedProductsServiceServer) GetProductOverview(context.Context, *GetProductOverviewRequest) (*GetProductOverviewResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProductOverview not implemented")
}
...
func _ProductsService_ListProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products.v1.ProductsService/ListProducts",
	}
...
func _ProductsService_CreateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products.v1.ProductsService/CreateProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductsService_GetProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products.v1.ProductsService/GetProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductsService_GetProductOverview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProductOverviewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductsServiceServer).GetProductOverview(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products.v1.ProductsService/GetProductOverview",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductsServiceServer).GetProductOverview(ctx, req.(*GetProductOverviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductsService_GetProductOverview_Handler,
		},
	},
